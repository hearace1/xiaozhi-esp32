...
// S3-CAM-DevPro 开发板配置（PCB 丝印 "S3-CAM-DevPro"）
// 摄像头引脚与 bread-compact-wifi-s3cam 完全一致；音频与 LCD 引脚不同。
// 屏幕连接器 P6 同时兼容 8P-ST7789 240x240 与 8P-ST7735S 128x160；
// 用 2 寸 ST7789 240x320 模组同样可直插（电气兼容）。
...
// 摄像头（DVP 并口，引脚同 bread-compact-wifi-s3cam）
...
// LCD 类型 —— 由 menuconfig 中 "LCD Type" 选择决定
